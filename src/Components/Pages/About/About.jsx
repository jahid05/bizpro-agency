    ...
    <div className="container mx-auto lg:py-20 py-10 lg:px-0 px-6">
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="relative">
          <div data-aos="fade-left" data-aos-duration="700" className="absolute lg:-top-4 -top-4 lg:left-14 left-8">
            <img className="w-10 lg:w-full" src={ellipse} alt="" />
          </div>
          <h3 data-aos="fade-left" data-aos-duration="700" className="lg:text-5xl md:text-4xl text-3xl font-semibold">About us</h3>
          <p data-aos="zoom-in" data-aos-duration="700" className="lg:text-xl md:text-lg text-gray-600 lg:py-4 py-2">
          ...
          <div className="">
            <div data-aos="fade-left" data-aos-duration="700" className="flex items-center gap-4 p-2">
              <div className="w-16">
                <img
            ...
            <div data-aos="fade-right" data-aos-duration="700" className="flex items-center gap-4 p-2">
              <div className="w-16">
                <img
                  className="bg-theme-color-200 lg:p-3 p-1 w-full rounded-lg"
                  src={team}
        ...
        <div data-aos="fade-left" data-aos-duration="700"  className="relative">
